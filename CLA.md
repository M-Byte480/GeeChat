...
Thank you for your interest in contributing to GeeChat ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document
effective, please sign it electronically by opening or commenting on a Pull Request in the GeeChat repository
at https://github.com/M-Byte480/GeeChat, where you will be prompted to sign this Agreement via the CLA Assistant bot.
This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than
...
Copyright. If You do not own the Copyright in the entire work of authorship, please contact M-Byte480 before Submitting
Contributions that include work you do not fully own.
...
of the license or licenses which We are using on the Submission Date for the Material or the following additional
licenses: GNU Affero General Public License v3.0 or later (AGPL-3.0-or-later)  (including any right to adopt any future
version of a license if permitted).

In addition, We may use the following licenses for Media in the Contribution: Creative Commons Attribution 4.0
International (CC BY 4.0)  (including any right to adopt any future version of a license if permitted).
...
(d) You have followed the instructions in Section 1 of this Agreement, if You do not own the Copyright in the entire
work of authorship Submitted.
...
6.1 This Agreement will be governed by and construed in accordance with the laws of Ireland excluding its conflicts of
law provisions. Under certain circumstances, the governing law in this section might be superseded by the United Nations
